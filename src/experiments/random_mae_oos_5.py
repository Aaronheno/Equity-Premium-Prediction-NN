"""
Out-of-sample evaluation using random search with MAE as the scoring function.

This module implements out-of-sample evaluation using random search hyperparameters
