"""
Out-of-sample evaluation using Bayesian optimization with MAE as the scoring function.

This module implements out-of-sample evaluation using Bayesian optimization hyperparameters
